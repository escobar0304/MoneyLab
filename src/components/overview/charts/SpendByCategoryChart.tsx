...
import { monthsWithActivity, spendByCategoryForMonth } from '../../../lib/core/derive';
import { monthLabel, formatMoney } from '../../../lib/core/format';
import { CHART_INK, MAX_CATEGORICAL_SERIES, OTHER_LABEL, categoryColorMap, rankedCategories } from '../../../lib/insight/chartTheme';
